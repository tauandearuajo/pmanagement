...
<head>
  ...
  <!--    Document Title-->
  <!-- ===============================================-->
  <title>Seguros - Patients management</title>
  ...
  <nav class="navbar navbar-vertical navbar-expand-lg">
    ...
    <div class="content">
      ...
      <div class="row gx-6 gy-3 mb-4 align-items-center">
        <div class="col-auto">
          <h2 class="mb-0">Seguros<span class="fw-normal text-700 ms-3"><?php 
          $sql_adv = "SELECT COUNT(*) AS qtd FROM insurance";
        ...
        <div class="col-auto"><a class="btn btn-primary px-5" href="novo_seguro.php"><i class="fa-solid fa-plus me-2"></i>Novo advgado</a></div>
      </div>
      ...
      <div class="row row-cols-1 row-cols-sm-2 row-cols-lg-3 row-cols-xxl-4 g-3 mb-9">
        <?php 
    $sql_lista = "SELECT*FROM insurance";
    ...
    while ($adv_lista = mysqli_fetch_array($query_advlista)) :
        ...
        <div class="col">
          <div class="card h-100 hover-actions-trigger">
            <div class="card-body">
              <div class="d-flex align-items-center">
                <h4 class="mb-2 line-clamp-1 lh-sm flex-1 me-5">Nome do seguro: <?= $adv_lista['name']?></h4>
              ...
              <div class="d-flex align-items-center mb-2"><span class="fa-solid fa-email me-2 text-700 fs--1 fw-extra-bold"></span>
                <p class="fw-bold mb-0 text-truncate lh-1">Fax : <span class="fw-semi-bold text-primary ms-1"> <?= $adv_lista['fax']?></span></p>
              </div>
