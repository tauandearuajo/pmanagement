...
<body>
  ...
  <main class="main" id="top">
    ...
    <div class="content">
      ...
      <h2 class="mb-4">Novo Doutor</h2>
      <div class="row">
        <div class="col-xl-9">
          <form class="row g-3 mb-6" method="post" action="model/add_doctor.php">
            <div class="col-sm-6 col-md-6">
              <div class="form-floating">
                <input class="form-control" id="floatingInputGrid" type="text" name='fistname' placeholder="Primeiro nome" />
                <label for="floatingInputGrid">Primeiro nome</label>
              </div>
            </div>
            <div class="col-sm-6 col-md-6">
              <div class="form-floating">
                <input class="form-control" id="floatingInputGrid" type="text" name='lastname' placeholder="Sobrenome" />
                <label for="floatingInputGrid">Sobrenome</label>
              </div>
            </div>
            <div class="col-sm-12 col-md-12">
              <div class="form-floating">
                <input class="form-control" id="floatingInputGrid" type="text" name='facility' placeholder="Habilidade do doutor" />
                <label for="floatingInputGrid">Habilidade do doutor</label>
              </div>
            </div>
            <div class="col-12 gy-6">
              <div class="row g-3 justify-content-end">
                ...
                <div class="col-auto">
                  <button class="btn btn-primary px-5 px-sm-15">Cadastrar doutor</button>
                </div>
              </div>
            </div>
          </form>
