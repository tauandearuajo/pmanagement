  ...
  <main class="main" id="top">
    ...
    <div class="content">
      ...
      <div class="row gx-6 gy-3 mb-4 align-items-center">
        <div class="col-auto">
          <h2 class="mb-0">Patients<span class="fw-normal text-700 ms-3"><?php
                                                                          $sql_adv = "SELECT COUNT(*) AS qtd FROM patient";
        ...
        <div class="col-auto"><a class="btn btn-primary px-5" href="novo_patient.php"><i class="fa-solid fa-plus me-2"></i>Novo Paciente</a></div>
      </div>
          ...
          <div class="col">
            <div class="card h-100 hover-actions-trigger">
              <div class="card-header bg-primary">
                <h4 class="mb-2 line-clamp-1 lh-sm flex-1 me-5 text-white">Nome: <?= $adv_lista['first_name']." ".$adv_lista['last_name']?></h4>
              </div>
              <div class="card-body">
              ...
              <div class="card-footer">
                <div class="row text-center justify-content-center">
                  <div class="col-auto ms-2 me-4">
                    <a class="btn btn-primary " href="patient_details.php?IDPATIENT=<?= $adv_lista['id'] ?>">
