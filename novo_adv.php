...
<head>
  ...
  <!--    Document Title-->
  <!-- ===============================================-->
  <title>Novo Advogado - Patients management</title>
...
<body>
  ...
  <main class="main" id="top">
    ...
    <div class="content">
      ...
      <h2 class="mb-4">Novo advogado</h2>
      <div class="row">
        <div class="col-xl-9">
          <form class="row g-3 mb-6" method="post" action="model/add_attorney.php">
            <div class="col-sm-12 col-md-12">
              <div class="form-floating">
                <input class="form-control" id="floatingInputGrid" type="text" name='name' placeholder="Nome completo" />
