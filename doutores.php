...
<head>
  ...
  <!--    Document Title-->
  <!-- ===============================================-->
  <title>Doutores - Patients management</title>
  ...
  <nav class="navbar navbar-vertical navbar-expand-lg">
    ...
    <div class="content">
      ...
      <div class="row gx-6 gy-3 mb-4 align-items-center">
        <div class="col-auto">
          <h2 class="mb-0">Doutores<span class="fw-normal text-700 ms-3"><?php
                                                                          $sql_adv = "SELECT COUNT(*) AS qtd FROM doctors";
        ...
        <div class="col-auto"><a class="btn btn-primary px-5" href="novo_doctor.php"><i class="fa-solid fa-plus me-2"></i>Novo doutor</a></div>
      </div>
      ...
      <div class="row row-cols-1 row-cols-sm-2 row-cols-lg-3 row-cols-xxl-4 g-3 mb-9">
        <?php
        $sql_doctor = "SELECT*FROM doctors order by id desc";
        $query_doctor = mysqli_query($connect, $sql_doctor);
        while ($doctor_lista = mysqli_fetch_array($query_doctor)) :
        ?>
          <div class="col">
            <div class="card h-100 hover-actions-trigger">
              <div class="card-body">
                <div class="d-flex align-items-center">
                  <h4 class="mb-2 line-clamp-1 lh-sm flex-1 me-5">Nome: <?= $doctor_lista['fistname'] . " " . $doctor_lista['lastname'] ?></h4>
                ...
                <div class="d-flex align-items-center mb-2"><span class="fa-solid fa-document me-2 text-700 fs--1 fw-extra-bold"></span>
                  <p class="fw-bold mb-0 text-truncate lh-1">Habilidade: <span class="fw-semi-bold text-primary ms-1"> <?= $doctor_lista['facility'] ?></span></p>
                </div>
                <div class="d-flex align-items-center mt-4">
                  <p class="mb-0 fw-bold fs--1">Criado em:<span class="fw-semi-bold text-600 ms-1"> <?= $doctor_lista['created_at'] ?></span></p>
                </div>
              </div>
            </div>
          </div>
