...
<head>
  ...
  <!--    Document Title-->
  <!-- ===============================================-->
  <title>Novo Doutor - Patients management</title>
          ...
          <ul class="navbar-nav flex-column" id="navbarVerticalNav">
            ...
            <li class="nav-item">
              ...
              <div class="nav-item-wrapper"><a class="nav-link dropdown-indicator label-1" href="#nv-project-management" role="button" data-bs-toggle="collapse" aria-expanded="false" aria-controls="nv-project-management">
                ...
                <div class="parent-wrapper label-1">
                  <ul class="nav collapse parent" data-bs-parent="#navbarVerticalCollapse" id="nv-project-management">
                    ...
                    <li class="nav-item"><a class="nav-link" href="novo_caso.php" data-bs-toggle="" aria-expanded="false">
                        <div class="d-flex align-items-center"><span class="nav-link-text">Criar novo</span>
                        </div>
                      </a>
                      <!-- more inner pages-->
              ...
              <div class="nav-item-wrapper"><a class="nav-link label-1" href="doutores.php" role="button" data-bs-toggle="" aria-expanded="false">
                  <div class="d-flex align-items-center"><span class="nav-link-icon"><span data-feather="pocket"></span></span><span class="nav-link-text-wrapper"><span class="nav-link-text">Doutores</span></span>
                  </div>
                </a>
              </div>
              <!-- parent pages - seguros-->
              <div class="nav-item-wrapper"><a class="nav-link label-1" href="seguros.php" role="button" data-bs-toggle="" aria-expanded="false">
                  <div class="d-flex align-items-center"><span class="nav-link-icon"><span data-feather="lock"></span></span><span class="nav-link-text-wrapper"><span class="nav-link-text">Seguros</span></span>
                  </div>
                </a>
              </div>
            </li>
              ...
              <ul class="nav justify-content-between nav-wizard" role="tablist">
                <li class="nav-item" role="presentation"><a class="nav-link active fw-semi-bold" href="#bootstrap-wizard-validation-tab1" data-bs-toggle="tab" data-wizard-step="1" aria-selected="true" role="tab">
                    <div class="text-center d-inline-block"><span class="nav-item-circle-parent"><span class="nav-item-circle">
                          ...
                          <!-- <span class="fas fa-lock"></span> Font Awesome fontawesome.com --></span></span><span class="d-none d-md-block mt-1 fs--1">Dados pessoais</span></div>
                  </a></li>
                <li class="nav-item" role="presentation">
                  <a class="nav-link fw-semi-bold" href="#bootstrap-wizard-validation-tab2" data-bs-toggle="tab" data-wizard-step="2" aria-selected="false" tabindex="-1" role="tab">
                    <div class="text-center d-inline-block">
                      <span class="nav-item-circle-parent">
                        <span class="nav-item-circle">
                          <svg class="svg-inline--fa fa-file-lines" aria-hidden="true" focusable="false" data-prefix="fas" data-icon="file-lines" role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 384 512" data-fa-i2svg="">
                          ...
                          <!-- <span class="fas fa-user"></span> Font Awesome fontawesome.com --></span></span><span class="d-none d-md-block mt-1 fs--1">Dados do ocorrido</span>
                    </div>
                  </a>
                </li>
                <li class="nav-item" role="presentation"><a class="nav-link fw-semi-bold" href="#bootstrap-wizard-validation-tab3" data-bs-toggle="tab" data-wizard-step="3" aria-selected="false" tabindex="-1" role="tab">
                    <div class="text-center d-inline-block"><span class="nav-item-circle-parent"><span class="nav-item-circle">
                          ...
                          </svg><!-- <span class="fas fa-file-alt"></span> Font Awesome fontawesome.com --></span></span><span class="d-none d-md-block mt-1 fs--1">Dados do seguro</span></div>
                  </a></li>
                <li class="nav-item" role="presentation"><a class="nav-link fw-semi-bold" href="#bootstrap-wizard-validation-tab4" data-bs-toggle="tab" data-wizard-step="4" aria-selected="false" tabindex="-1" role="tab">
                    <div class="text-center d-inline-block"><span class="nav-item-circle-parent"><span class="nav-item-circle"><svg class="svg-inline--fa fa-check" aria-hidden="true" focusable="false" data-prefix="fas" data-icon="check" role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 448 512" data-fa-i2svg="">
                          ...
                          </svg><!-- <span class="fas fa-check"></span> Font Awesome fontawesome.com --></span></span><span class="d-none d-md-block mt-1 fs--1">Finalizar </span></div>
                  </a></li>
              </ul>
            </div>
            <div class="card-body pt-4 pb-0">
              <form class="row g-3 mb-6" method="post" action="#" class="needs-validation" id="wizardValidationForm2" novalidate="novalidate" validate>
                <div class="tab-content">
                  <div class="tab-pane active" role="tabpanel" aria-labelledby="bootstrap-wizard-validation-tab1" id="bootstrap-wizard-validation-tab1">
                    <div class="row">
                      <div class="col-sm-12 col-md-12 mt-3 mb-3">
                        <h4 class="mb-3">Localidade</h4>
                        <div class="form-check form-check-inline">

                          <input class="form-check-input" id="inlineRadio1" name="local_option" type="radio" name="inlineRadioOptions" value="Miami" />

                          <label class="form-check-label" for="inlineRadio1">Miami</label>
                        </div>
                        <div class="form-check form-check-inline">

                          <input class="form-check-input" id="inlineRadio2" name="local_option" type="radio" name="inlineRadioOptions" value="Plantation" />

                          <label class="form-check-label" for="inlineRadio2">Plantation</label>
                        </div>
                        <div class="form-check form-check-inline">

                          <input class="form-check-input" id="inlineRadio2" name="local_option" type="radio" name="inlineRadioOptions" value="Orlando" />

                          <label class="form-check-label" for="inlineRadio2">Orlando</label>
                        </div>
                        <div class="form-check form-check-inline">

                          <input class="form-check-input" id="inlineRadio2" name="local_option" type="radio" name="inlineRadioOptions" value="Altamonte Springs" />

                          <label class="form-check-label" for="inlineRadio2">Altamonte Springs</label>
                        </div>
                      ...
                      <div class="col-sm-6 col-md-6 mb-3">
                        <div class="form-floating">
                          ...
                          <input class="form-control" id="floatingInputGrid" type="text" name='first_name' placeholder="Nome completo" required />
                          <label for="floatingInputGrid">Primeiro nome</label>
                        </div>
                      </div>
                      <div class="col-sm-6 col-md-6 mb-3">
                        <div class="form-floating">
                          <input class="form-control" id="floatingInputGrid" type="text" name='last_name' placeholder="Nome completo" required />
                          <label for="floatingInputGrid">Sobrenome</label>
                        </div>
                      </div>
                      <div class="col-sm-6 col-md-6 mb-3">
                        <div class="form-floating">
                          <input class="form-control" id="floatingInputGrid" type="text" name='ss' placeholder="Nome completo" required />
                          <label for="floatingInputGrid">S.S#</label>
                        </div>
                      </div>
                      <div class="col-sm-6 col-md-6 mb-3">
                        <div class="form-floating">
                          <input class="form-control" id="floatingInputGrid" type="text" name='phone_number' placeholder="Nome completo" required />
                          <label for="floatingInputGrid">Telefone</label>
                        </div>
                      </div>
                      <div class="col-sm-6 col-md-6 mb-3">
                        <div class="form-floating">
                          <input class="form-control" id="date_brithday" type="date" name='date_brithday' placeholder="Nome completo" required />

                          <label for="date_brithday">Data de aniversario</label>
                        </div>
                      </div>
                      <div class="col-sm-6 col-md-6 mb-3">
                        <div class="form-floating">
                          <input class="form-control" id="date_brithday" type="text" name='age' placeholder="Nome completo" required />

                          <label for="date_brithday">Idade</label>
                        </div>
                      </div>
                      <div class="col-sm-6 col-md-6 mb-3">
                        <div class="form-floating">
                          ...
                          <label for="floatingSelect">Selecione o sexo</label>
                        </div>
                      </div>
                      <div class="col-sm-6 col-md-6 mb-3">
                        <div class="form-floating">
                          <input class="form-control" id="floatingInputGrid" type="text" name='address' placeholder="Nome completo" required />
                          <label for="floatingInputGrid">Endereço</label>
                        </div>
                      </div>
                      <div class="col-sm-6 col-md-6 mb-3">
                        <div class="form-floating">
                          <input class="form-control" id="floatingInputGrid" type="text" name='city_state_zip' placeholder="Nome completo" required />
                          <label for="floatingInputGrid">Cidade / Estado / ZIP code</label>
                        </div>
                      </div>
                      <div class="col-sm-6 col-md-6 mb-3">
                        <div class="form-floating">
                          <input class="form-control" id="floatingInputGrid" type="text" name='work' placeholder="Nome completo" required />
                          <label for="floatingInputGrid">Trabalho</label>
                        </div>
                      </div>
                      <div class="col-sm-6 col-md-6 mb-3">
                        <div class="form-floating">
                          <input class="form-control" id="floatingInputGrid" type="text" name='home' placeholder="Nome completo" required />
                          <label for="floatingInputGrid">Casa</label>
                        </div>
                      </div>
                  ...
                  <div class="tab-pane" role="tabpanel" aria-labelledby="bootstrap-wizard-validation-tab2" id="bootstrap-wizard-validation-tab2">
                    <div class="row g-4 mb-4 dz-clickable" data-dropzone="data-dropzone" data-options="{&quot;maxFiles&quot;:1,&quot;data&quot;:[{&quot;name&quot;:&quot;avatar.webp&quot;,&quot;size&quot;:&quot;54kb&quot;,&quot;url&quot;:&quot;../../assets/img/team&quot;}]}">
                      ...
                      <div class="col-sm-6 col-md-6">
                        <div class="form-floating">
                          <input class="form-control" id="date_entered" type="date" name='date_entered' placeholder="Nome completo" required />

                          <label for="date_entered">Data de entrada</label>
                        </div>
                      </div>
                      <div class="col-sm-6 col-md-6">
                        <div class="form-floating">
                          <input class="form-control" id="date_accident" type="date" name='date_accident' placeholder="Nome completo" required />

                          <label for="date_accident">Data do acidente</label>
                        </div>
                      </div>
                      <div class="col-sm-6 col-md-6">
                        <div class="form-floating">
                          <div class="form-floating">
                            <select class="form-select" id="floatingSelect" name="type_of_accident" aria-label="Floating label select example">
                              <option value="MVA">MVA</option>
                              <option value="PEDESTRIAN">PEDESTRIAN</option>
                              <option value="S&F">S&F</option>
                              <option value="PREMISES LIABILITY">PREMISES LIABILITY</option>
                            </select>
                            <label for="floatingSelect">Tipo de acidente</label>
                          </div>
                        </div>
                      </div>
                      <div class="col-sm-6 col-md-6">
                        <div class="form-floating">
                          <input class="form-control" id="office_center" type="text" name='referral_doctor' placeholder="Nome completo" required />
                          <label for="office_center">referencia do doutor</label>
                        </div>
                      </div>
                      <div class="col-sm-6 col-md-6">
                        <div class="form-floating">
                          <input class="form-control" id="employee_name" type="text" name='phone' placeholder="Nome completo" required />
                          <label for="employee_name">Phone</label>
                        </div>
                      </div>
                      <div class="col-sm-6 col-md-6">
                        <div class="form-floating">
                          <input class="form-control" id="scheduling_status" type="text" name='chief_complaint' placeholder="Nome completo" required />
                          <label for="scheduling_status">Chief complain 1</label>
                        </div>
                      </div>
                      <div class="col-sm-6 col-md-6">
                        <div class="form-floating">
                          <input class="form-control" id="scheduling_status" type="text" name='chief_complaint2' placeholder="Nome completo" required />
                          <label for="scheduling_status">Chief complain 2</label>
                        </div>
                      </div>
                      <div class="col-sm-6 col-md-6">
                        <div class="form-floating">
                          <input class="form-control" id="scheduling_status" type="text" name='chief_complaint3' placeholder="Nome completo" required />
                          <label for="scheduling_status">Chief complain 3</label>
                        </div>
                      </div>
                      <div class="col-sm-6 col-md-6">
                        <div class="form-floating">
                          <div class="form-floating">
                            <select class="form-select" id="floatingSelect" name="pain_management_seen" aria-label="Floating label select example">
                              <option value="MVA">Yes</option>
                              <option value="PEDESTRIAN">No</option>
                            </select>
                            <label for="floatingSelect">Pain management seen?</label>
                          </div>
                        </div>
                      </div>
                    </div>
                  ...
                  <div class="tab-pane" role="tabpanel" aria-labelledby="bootstrap-wizard-validation-tab3" id="bootstrap-wizard-validation-tab3">
                    <div class="row gx-3 gy-2">
                      <h4 class="mt-3 text-center">PIP Insurance Information</h4>
                      <div class="col-sm-6 col-md-6">
                        <div class="form-floating">
                          <select class="form-select" id="floatingSelect" name="insurance_id" aria-label="Floating label select example">
                            <?php
                            $sql_adv = "SELECT*FROM insurance";
                          ...
                          <label for="floatingSelect">Selecione o seguro</label>
                        </div>
                      </div>
                      <div class="col-sm-6 col-md-6">
                        <div class="form-floating">
                          <input class="form-control" id="chief_complaint" type="text" name='chief_complaint' placeholder="Nome completo" required />
                          <label for="chief_complaint">Adjuste</label>
                        </div>
                      </div>
                      <div class="col-sm-6 col-md-6">
                        <div class="form-floating">
                          <input class="form-control" id="chief_complaint" type="text" name='chief_complaint' placeholder="Nome completo" required />
                          <label for="chief_complaint">Phone</label>
                        </div>
                      </div>
                      <div class="col-sm-6 col-md-6">
                        <div class="form-floating">
                          <input class="form-control" id="chief_complaint" type="text" name='chief_complaint' placeholder="Nome completo" required />
                          <label for="chief_complaint">Policy</label>
                        </div>
                      </div>
                      <div class="col-sm-6 col-md-6">
                        <div class="form-floating">
                          <input class="form-control" id="chief_complaint" type="text" name='chief_complaint' placeholder="Nome completo" required />
                          <label for="chief_complaint">Claim Number</label>
                        </div>
                      </div>
                    </div>
                    <div class="row">
                      <div class="col-sm-6 col-md-6">
                        <h4 class="mt-5"> 3RD party bi information</h4>
                        <div class="form-floating">
                          <select class="form-select" id="floatingSelect" name="insurance_id" aria-label="Floating label select example">
                            <?php
                            $sql_adv = "SELECT*FROM insurance";
                      ...
                      <div class="col-sm-6 col-md-6">
                        <h4 class="mt-5">Attoney information</h4>
                        <div class="form-floating">
                      ...
                      <div class="col-sm-6 col-md-6">
                        <h4 class="mt-5">Doctor information</h4>
                        <div class="form-floating">
                          <select class="form-select" id="floatingSelect" name="attorney_id" aria-label="Floating label select example" required>
                            <?php
                            $sql_adv = "SELECT*FROM doctors";
                            $query_adv = mysqli_query($connect, $sql_adv);
                            while ($adv = mysqli_fetch_array($query_adv)):
                            ?>
                              <option value="<?= $adv['id'] ?>"><?= $adv['full_name'] ?></option>
                            <?php endwhile; ?>
                          </select>

                          <label for="floatingSelect">Selecione o Doutor</label>
                        </div>
                      </div>
                    </div>
                  ...
                  <div class="tab-pane" role="tabpanel" aria-labelledby="bootstrap-wizard-validation-tab4" id="bootstrap-wizard-validation-tab4">
                    <div class="row flex-center pb-8 pt-4 gx-3 gy-4">
                      <div class="col-12 col-sm-auto">
                        <div class="text-center "><img class="d-dark-none" src=assets/img/spot-illustrations/38.webp" alt="" width="220"><img class="d-light-none" src="../../assets/img/spot-illustrations/dark_38.webp" alt="" width="220"></div>
                      </div>
                      <div class="col-12 col-sm-auto justify-content-center">
                        <div class="text-center ">
                          <h2 class="mb-3">Clique em finalizar cadastro para registrar o paciente!</h2>
                          <button type="submit" class="btn btn-lg btn-primary px-6">Finalizar cadastro</button>
                        </div>
                      </div>
                    </div>
                  </div>
            ...
            <div class="card-footer border-top-0" data-wizard-footer="data-wizard-footer">
              <div class="d-flex pager wizard list-inline mb-0">
                <button class="d-none btn btn-link ps-0" type="button" data-wizard-prev-btn="data-wizard-prev-btn"><svg class="svg-inline--fa fa-chevron-left me-1" data-fa-transform="shrink-3" aria-hidden="true" focusable="false" data-prefix="fas" data-icon="chevron-left" role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 320 512" data-fa-i2svg="" style="transform-origin: 0.3125em 0.5em;">
                  ...
                  </svg><!-- <span class="fas fa-chevron-left me-1" data-fa-transform="shrink-3"></span> Font Awesome fontawesome.com -->Voltar</button>
                <div class="flex-1 text-end">
                  <button class="btn btn-primary px-6 px-sm-6" type="submit" data-wizard-next-btn="data-wizard-next-btn">Próximo<svg class="svg-inline--fa fa-chevron-right ms-1" data-fa-transform="shrink-3" aria-hidden="true" focusable="false" data-prefix="fas" data-icon="chevron-right" role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 320 512" data-fa-i2svg="" style="transform-origin: 0.3125em 0.5em;">
                      <g transform="translate(160 256)">
                        <g transform="translate(0, 0)  scale(0.8125, 0.8125)  rotate(0 0 0)">
