...
<head>
  ...
  <!--    Document Title-->
  <!-- ===============================================-->
  <title>Novo seguro - Patients management</title>
...
<body>
  ...
  <main class="main" id="top">
              ...
              <div class="nav-item-wrapper"><a class="nav-link dropdown-indicator label-1" href="#nv-home" role="button" data-bs-toggle="collapse" aria-expanded="true" aria-controls="nv-home">
                ...
                <div class="parent-wrapper label-1">
                  <ul class="nav collapse parent show" data-bs-parent="#navbarVerticalCollapse" id="nv-home">
                    ...
                    <li class="nav-item"><a class="nav-link active" href="dashboard/crm.html" data-bs-toggle="" aria-expanded="false">
    ...
    <div class="content">
      ...
      <h2 class="mb-4">Novo Seguro</h2>
      <div class="row">
        <div class="col-xl-9">
          <form class="row g-3 mb-6" method="post" action="model/add_insurance.php">
            <div class="col-sm-6 col-md-6">
              <div class="form-floating">
                <input class="form-control" id="floatingInputGrid" type="text" name='name' placeholder="Primeiro nome" />
                <label for="floatingInputGrid">Nome do Seguro</label>
              </div>
            </div>
            <div class="col-sm-6 col-md-6">
              <div class="form-floating">
                <input class="form-control" id="floatingInputGrid" type="text" name='address' placeholder="Sobrenome" />
                <label for="floatingInputGrid">Endereço</label>
              </div>
            </div>
            <div class="col-sm-6 col-md-6">
              <div class="form-floating">
                <input class="form-control" id="floatingInputGrid" type="text" name='phone_number' placeholder="Sobrenome" />
                <label for="floatingInputGrid">Telefone</label>
              </div>
            </div>
            <div class="col-sm-6 col-md-6">
              <div class="form-floating">
                <input class="form-control" id="floatingInputGrid" type="text" name='fax' placeholder="Sobrenome" />
                <label for="floatingInputGrid">Fax</label>
              </div>
            </div>
            <div class="col-sm-12 col-md-12">
              <div class="form-floating">
                <input class="form-control" id="floatingInputGrid" type="text" name='maps_iframe' placeholder="Sobrenome" />
                <label for="floatingInputGrid">Iframe do maps</label>
              </div>
            </div>
            <div class="col-12 gy-6">
              <div class="row g-3 justify-content-end">
                ...
                <div class="col-auto">
                  <button class="btn btn-primary px-5 px-sm-15">Cadastrar seguro</button>
                </div>
              </div>
            </div>
          </form>
